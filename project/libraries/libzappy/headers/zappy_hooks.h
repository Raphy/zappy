...
** Last update Sun Jul 13 01:22:30 2014 raphael defreitas
*/
...
void		zs_hook_cmd_look(t_zc *, t_zsh_client_basic h, void *d);
void		zs_hook_cmd_inventory(t_zc *, t_zsh_client_basic h, void *d);
...
void		zs_hook_cmd_invocation(t_zc *, t_zsh_client_basic h, void *d);
void		zs_hook_cmd_fork(t_zc *, t_zsh_client_basic h, void *d);
void		zs_hook_cmd_team_slots(t_zc *, t_zsh_uint_basic h, void *d);
