...
** Last update Sat Jul 12 23:20:53 2014 raphael defreitas
*/
...
bool		zs_cmd_plv(t_zs *this, t_zc *zc, const char *cmd)
{
  unsigned int	uid;

  if (strncmp(cmd, "plv", 3) != 0)
    return (false);
  if (!my_match(cmd, "plv *") ||
